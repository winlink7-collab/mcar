...
function icon($name, $size = 20, $stroke = 1.6) {
    $icons = [
        ...
        'whatsapp' => '<path fill="currentColor" stroke="none" d="M12.04 2a9.96 9.96 0 0 0-8.6 14.94L2 22l5.22-1.36a9.96 9.96 0 0 0 4.82 1.22A9.96 9.96 0 1 0 12.04 2m0 1.67a8.28 8.28 0 0 1 8.3 8.29 8.28 8.28 0 0 1-8.3 8.29 8.24 8.24 0 0 1-4.21-1.15l-.3-.18-3.1.82.83-3.02-.2-.31a8.24 8.24 0 0 1-1.29-4.45 8.28 8.28 0 0 1 8.27-8.29m-4.59 4.45c-.22 0-.56.08-.86.4-.3.3-1.13 1.1-1.13 2.68 0 1.59 1.16 3.12 1.32 3.34.16.22 2.25 3.58 5.57 4.88 2.76 1.1 3.32.88 3.92.82.6-.05 1.94-.79 2.22-1.56.27-.77.27-1.42.19-1.56-.08-.14-.3-.22-.63-.38-.33-.17-1.94-.96-2.25-1.07-.3-.11-.52-.16-.74.16-.22.33-.85 1.07-1.04 1.28-.19.22-.38.24-.7.08-.33-.17-1.38-.51-2.63-1.62-.97-.86-1.63-1.94-1.82-2.27-.19-.33-.02-.5.14-.66.14-.14.31-.36.47-.55.16-.2.22-.33.33-.55.11-.22.05-.41-.02-.58-.08-.16-.73-1.79-1.02-2.45-.27-.64-.55-.56-.74-.56h-.62z"/>',
